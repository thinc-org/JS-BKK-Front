...
const Dashboard: React.FC = observer(() => {
  ...
  return (
    <div className='px-10'>
      <span className='text-gray-500'>{firstname} {lastname}</span>
          ...
          <div className='bg-gray-200 align-bottom w-64 h-40  justify-center items-end'>
            ...
            <div className={!isCameraOpen ? "mt-24" : "mt-1"}>
              <div className= "border border-yellow-dark px-2 mx-4 mb-2  flex rounded">
                ...
                <Button className='font-semibold' type='button' onClick ={()=>{openCamera(!isCameraOpen)}}>
                  {isCameraOpen ? <div>Close Camera</div> : <div>Open Camera</div>}
                </Button>
              </div>
            </div>
      ...
      <div className='mt-12'>
        ...
        <div className=" px-24 py-8 bg-white rounded-b">
          Firstname Lastname
        </div>
        <button className="text-white font-semibold" onClick={() => addUserToNetwork('test04')}>
          No idea? Here are some questions!
       
        </button>

        <button className="text-white font-semibold" onClick={() => createNetworkingProfile()}>
          create profile
        </button>
        <ul className='pl-16 '>
          <li>
            <span className='block py-1 text-white font-semibold'>Where do you work?</span>
          </li>
          <li>
            <span className='block py-1 text-white font-semibold'>What is your stack?</span>
          </li>
          <li>
